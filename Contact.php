...
<style type="text/css">
<!--
.style9 {font-size: 95%; font-weight: bold; color: #003300; font-family: "Courier New", "Lucidia Console", "Monaco", Monospace; }
.style10 {
	font-size: 100%;
	font-weight: bold;
}
...
<div id="wrapper">
  ...
  <div id="content">
    ...
    <table width="100%" height="152" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td>Bashundhara City Complex<br/>Block-C,Bashundhara<br/>Dhaka</td>


        <td>Sanmar Ocean City<br/>2 no gate,East Nasirabad<br/>Chittagong</td>
      </tr>
      <tr>
        <td>Phone: 01551096087</td>
        <td>Phone: 01843357281</td>
      </tr>
      <tr>
        <td>Email: Riya@gmail.com</td>
        <td>Email: Laboni@gmail.com</td>
