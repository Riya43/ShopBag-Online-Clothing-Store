  ...
  <div id="wrapper">
    ...
    <div id="content">
      ...
      <table width="100%" border="1" bordercolor="#003300">
        ...
        $con = mysqli_connect("localhost", "root", "", "shopbag");
...
WHERE customer_registration.CustomerId=shopping_cart_final.CustomerId ";
        ...
        ?>
          <tr>
            ...
            <td class="style3">
              <div align="left" class="style9 style5"><strong><?php echo $CustomerName; ?></strong></div>
            </td>
            <td class="style3">
              <div align="left" class="style9 style5"><strong><?php echo $ItemName; ?></strong></div>
            </td>
            <td class="style3">
              <div align="left" class="style9 style5"><strong><?php echo $Quantity; ?></strong></div>
            </td>
            <td class="style3">
              <div align="left" class="style9 style5"><strong><?php echo $Price; ?></strong></div>
            </td>
            <td class="style3">
              <div align="left" class="style9 style5"><strong><?php echo $Total; ?></strong></div>
            </td>
