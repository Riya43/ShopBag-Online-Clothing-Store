...
<head>
<title>shopbag | Online Clothing Store</title>
<link href="style.css" rel="stylesheet" type="text/css" />
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<style type="text/css">
<!--
.style5 {font-size: 85%; font-weight: bold; color: #003300; font-family: "Courier New", "Lucidia Console", "Monaco", Monospace; }
-->
</style>
...
.style1 {
	font-size: small;
	font-family: "Courier New", "Lucidia Console", "Monaco", Monospace;
}
.style2 {font-family: "Courier New", "Lucidia Console", "Monaco", Monospace}
...
.style13 {font-family: "Courier New", "Lucidia Console", "Monaco", Monospace;
	font-size: small;
	font-weight: bold;
	color: #000000;
}
...
<style type="text/css">
<!--
.style9 {font-size: 95%; font-weight: bold; color: #003300; font-family: "Lucidia Console", "Monaco", Monospace; }
-->
</style>
</head>
<body>
